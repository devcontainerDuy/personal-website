...
const Input = forwardRef<InputHandle, InputProps>(
	(
		...
		const variantClasses = {
			primary:
				"border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400",
			danger:
				"border-red-500 text-red-500 focus:border-red-500 focus:ring-red-500 placeholder-red-400",
			success:
				"border-green-500 text-green-900 focus:ring-green-500 focus:border-green-500 placeholder-green-700",
		};
